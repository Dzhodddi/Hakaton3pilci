...
export function GoogleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path 
        fill="#1976D2" 
        d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571l6.19,5.238C39.901,36.639,44,30.823,44,24C44,22.659,43.862,21.35,43.611,20.083z" 
      />
    </svg>
  );
}